...
from diffusion.datasets import load_data, data_loader, balance_sample_screen
...
def main(args):
    ...
    state_dict = th.load("log/2024-05-23-16-03/model_N08000.pt")
    ema_N.load_state_dict(state_dict["ema"])
    ema_N.to(dist_util.dev())
    ema_N.eval()
    state_dict = th.load("log/2024-05-23-16-03/model_T08000.pt")
