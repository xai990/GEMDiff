"""
This script performs data visualization and classification analysis using gene expression data.

It loads gene expression data, optionally loads synthetic data generated by a diffusion model,
visualizes the data using UMAP, and performs SVM classification to evaluate the data's separability.

Usage:
    python script_name.py --config configs/your_config.yaml --dir_out path/to/output/dir --dir path/to/log/dir [--sample_path path/to/synthetic/data.npz] [--gene_set your_gene_set] [--plot sample|origin]

    --config: Path to the configuration YAML file.
    --dir_out: Directory to save output visualizations.
    --dir: Directory to save logs.
    --sample_path: Path to the numpy file containing synthetic data (if plotting synthetic data).
    --gene_set: The gene set to use for filtering.
    --plot: Specifies whether to plot synthetic data ("sample") or original data ("origin").
